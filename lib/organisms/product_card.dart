...
class ProductCard extends StatelessWidget {
  ...
  factory ProductCard.menu({
    ...
    return ProductCard(
      ...
      primaryInfoColor: Colors.blue[700],
      primaryInfoBackgroundColor: Colors.blue.withValues(alpha: 0.1),
      layout: layout,
  ...
  factory ProductCard.clothing({
    ...
    return ProductCard(
      ...
      primaryInfoColor: Colors.orange[700],
      primaryInfoBackgroundColor: Colors.orange.withValues(alpha: 0.1),
      actionBadgeColor: quantity != null && quantity > 5 ? Colors.green : Colors.orange,
